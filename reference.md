...
**q:** `typing.Optional[str]` — Query in <a href ="https://lucene.apache.org/core/2_9_4/queryparsersyntax.html">Lucene query string syntax</a>.
...
## Events
<details><summary><code>client.events.<a href="src/auth0.management/events/client.py">subscribe</a>(...) -> typing.Iterator[bytes]</code></summary>
<dl>
<dd>
...
**from:** `typing.Optional[str]` — Opaque token representing position in the stream. If not provided, stream will start from the latest events.
...
**from_timestamp:** `typing.Optional[str]` — RFC-3339 timestamp indicating where to start streaming events from. This should only be used on the initial query when a cursor may not be available. Subsequent requests should use the cursor (from) as it will be more accurate.
...
**event_type:** `typing.Optional[typing.Union[typing.Optional[EventStreamSubscribeEventsEventTypeEnum], typing.Sequence[typing.Optional[EventStreamSubscribeEventsEventTypeEnum]]]]` — Event type(s) to listen for. Specify multiple times for multiple types (e.g., ?event_type=user.created&event_type=user.updated). If not provided, all event types will be streamed.
...
**search:** `typing.Optional[str]` — Search for groups by name or external ID.
...
<details><summary><code>client.refresh_tokens.<a href="src/auth0.management/refresh_tokens/client.py">revoke</a>(...)</code></summary>
<dl>
<dd>
...
**ids:** `typing.Optional[typing.List[str]]` — Array of refresh token IDs to revoke. Limited to 100 at a time.
...
## Roles
<details><summary><code>client.roles.<a href="src/auth0.management/roles/client.py">list</a>(...) -> ListRolesResponseContent</code></summary>
<dl>
<dd>
...
**q:** `typing.Optional[str]` — Query in <a target='_new' href ='https://lucene.apache.org/core/2_9_4/queryparsersyntax.html'>Lucene query string syntax</a>. Some query types cannot be used on metadata fields, for details see <a href='https://auth0.com/docs/users/search/v3/query-syntax#searchable-fields'>Searchable Fields</a>.
...
<details><summary><code>client.connections.directory_provisioning.<a href="src/auth0.management/connections/directory_provisioning/client.py">list_synchronized_groups</a>(...) -> ListSynchronizedGroupsResponseContent</code></summary>
<dl>
<dd>
...
<details><summary><code>client.connections.directory_provisioning.<a href="src/auth0.management/connections/directory_provisioning/client.py">set</a>(...)</code></summary>
<dl>
<dd>
...
**connection_id:** `typing.Optional[str]` — If provided, this will allow editing of the provided connection during the Self-Service Enterprise Configuration flow
...
**client_id_metadata_document_supported:** `typing.Optional[bool]` — Whether the authorization server supports retrieving client metadata from a client_id URL.
