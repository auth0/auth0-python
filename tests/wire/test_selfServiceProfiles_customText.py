...
def test_selfServiceProfiles_customText_list_() -> None:
    ...
    client.self_service_profiles.custom_text.list(id="id", language="en", page="get-started")
...
def test_selfServiceProfiles_customText_set_() -> None:
    ...
    client = get_client(test_id)
    client.self_service_profiles.custom_text.set(id="id", language="en", page="get-started", request={"key": "value"})
