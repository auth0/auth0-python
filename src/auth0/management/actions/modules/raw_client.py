...
class RawModulesClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetActionModulesResponseContent,  # type: ignore
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateActionModuleResponseContent]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "secrets": convert_and_respect_annotation_metadata(
                    object_=secrets, annotation=typing.Sequence[ActionModuleSecretRequest], direction="write"
                ),
                "dependencies": convert_and_respect_annotation_metadata(
                    object_=dependencies, annotation=typing.Sequence[ActionModuleDependencyRequest], direction="write"
                ),
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateActionModuleResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
    ...
    ) -> HttpResponse[GetActionModuleResponseContent]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetActionModuleResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        ...
        *,
        ...
        dependencies: typing.Optional[typing.Sequence[ActionModuleDependencyRequest]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateActionModuleResponseContent]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateActionModuleResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetActionModuleActionsResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
    ...
    ) -> HttpResponse[RollbackActionModuleResponseContent]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RollbackActionModuleResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawModulesClient:
    ...
    async def create(
        ...
        *,
        ...
        publish: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateActionModuleResponseContent]:
        """
        Create a new Actions Module for reusable code across actions.
    ...
    async def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetActionModuleResponseContent]:
        """
        Retrieve details of a specific Actions Module by its unique identifier.
    ...
    async def update(
        ...
        *,
        ...
        dependencies: typing.Optional[typing.Sequence[ActionModuleDependencyRequest]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateActionModuleResponseContent]:
        """
        Update properties of an existing Actions Module, such as code, dependencies, or secrets.
    ...
    async def rollback(
        self, id: str, *, module_version_id: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RollbackActionModuleResponseContent]:
        """
        Rolls back an Actions Module's draft to a previously created version. This action copies the code, dependencies, and secrets from the specified version into the current draft.
