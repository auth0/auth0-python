...
class EventStreamCloudEventConnectionCreatedObject1OptionsAttributeMap(UniversalBaseModel):
    """
    Mapping of claims received from the identity provider (IdP)
    """

    attributes: typing.Optional[EventStreamCloudEventConnectionCreatedObject1OptionsAttributeMapAttributes] = None
    userinfo_scope: typing.Optional[str] = pydantic.Field(default=None)
    """
    Scopes to send to the IdP's Userinfo endpoint
    """

    mapping_mode: typing.Optional[EventStreamCloudEventConnectionCreatedObject1OptionsAttributeMapMappingModeEnum] = (
        None
    )
