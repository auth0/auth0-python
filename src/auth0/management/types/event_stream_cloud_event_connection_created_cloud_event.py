...
class EventStreamCloudEventConnectionCreatedCloudEvent(UniversalBaseModel):
    """
    Represents an event that occurs when a connection is created.
    """

    specversion: EventStreamCloudEventSpecVersionEnum
    type: EventStreamCloudEventConnectionCreatedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventConnectionCreatedData
