...
class EventStreamCloudEventConnectionDeletedObject0OptionsAttributeMap(UniversalBaseModel):
    """
    ...
    attributes: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsAttributeMapAttributes] = None
    userinfo_scope: typing.Optional[str] = pydantic.Field(default=None)
    """
    Scopes to send to the IdP's Userinfo endpoint
    """

    mapping_mode: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsAttributeMapMappingModeEnum] = (
        None
    )
