...
class EventStreamCloudEventConnectionCreatedObject3(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionCreatedObject3Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionCreatedObject3ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject3Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionCreatedObject3Options] = None
    ...
    strategy: EventStreamCloudEventConnectionCreatedObject3StrategyEnum
