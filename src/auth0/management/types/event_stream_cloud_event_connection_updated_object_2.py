...
class EventStreamCloudEventConnectionUpdatedObject2(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2Options] = None
    ...
    strategy: EventStreamCloudEventConnectionUpdatedObject2StrategyEnum
