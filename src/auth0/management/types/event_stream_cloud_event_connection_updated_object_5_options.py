...
class EventStreamCloudEventConnectionUpdatedObject5Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionUpdatedObject5OptionsUpstreamParams] = None
