...
class EventStreamCloudEventConnectionDeletedObject0OptionsConnectionSettings(UniversalBaseModel):
    """
    ...
    pkce: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsConnectionSettingsPkceEnum] = None
