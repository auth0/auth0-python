...
class EventStreamCloudEventConnectionDeletedObject5Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject5OptionsUpstreamParams] = None
