...
from .event_stream_cloud_event_group_updated_object_1_type_enum import EventStreamCloudEventGroupUpdatedObject1TypeEnum


class EventStreamCloudEventGroupUpdatedObject1(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventGroupUpdatedObject1TypeEnum
