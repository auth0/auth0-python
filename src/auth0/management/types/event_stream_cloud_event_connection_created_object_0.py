...
class EventStreamCloudEventConnectionCreatedObject0(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionCreatedObject0Authentication] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject0Metadata] = None
    ...
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts] = None
    options: typing.Optional[EventStreamCloudEventConnectionCreatedObject0Options] = None
    ...
    strategy: EventStreamCloudEventConnectionCreatedObject0StrategyEnum
