...
class EventStreamCloudEventConnectionCreatedObject7Options(UniversalBaseModel):
    """
    ...
    identity_api: typing.Optional[EventStreamCloudEventConnectionCreatedObject7OptionsIdentityApiEnum] = None
    ...
    tenant_domain: typing.Optional[EventStreamCloudEventConnectionCreatedObject7OptionsTenantDomainOne] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionCreatedObject7OptionsUpstreamParams] = None
    ...
    userid_attribute: typing.Optional[EventStreamCloudEventConnectionCreatedObject7OptionsUseridAttributeEnum] = None
    waad_protocol: typing.Optional[EventStreamCloudEventConnectionCreatedObject7OptionsWaadProtocolEnum] = None
