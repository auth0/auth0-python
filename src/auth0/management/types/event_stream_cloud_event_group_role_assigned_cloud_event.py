...
class EventStreamCloudEventGroupRoleAssignedCloudEvent(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventGroupRoleAssignedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventGroupRoleAssignedData
