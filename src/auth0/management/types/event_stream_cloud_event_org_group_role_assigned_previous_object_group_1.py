...
from .event_stream_cloud_event_org_group_role_assigned_previous_object_group_1_type_enum import (
...
class EventStreamCloudEventOrgGroupRoleAssignedPreviousObjectGroup1(UniversalBaseModel):
    ...
    type: EventStreamCloudEventOrgGroupRoleAssignedPreviousObjectGroup1TypeEnum
