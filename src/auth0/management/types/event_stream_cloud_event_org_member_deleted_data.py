...
from .event_stream_cloud_event_org_member_deleted_previous_object import (
    EventStreamCloudEventOrgMemberDeletedPreviousObject,
)


class EventStreamCloudEventOrgMemberDeletedData(UniversalBaseModel):
    """
    The event payload.
    """

    object: EventStreamCloudEventOrgMemberDeletedObject
    previous_object: typing.Optional[EventStreamCloudEventOrgMemberDeletedPreviousObject] = None
