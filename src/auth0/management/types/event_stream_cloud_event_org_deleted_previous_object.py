...
from .event_stream_cloud_event_org_deleted_previous_object_metadata import (
    EventStreamCloudEventOrgDeletedPreviousObjectMetadata,
)


class EventStreamCloudEventOrgDeletedPreviousObject(UniversalBaseModel):
    """
    ...
    metadata: typing.Optional[EventStreamCloudEventOrgDeletedPreviousObjectMetadata] = None
