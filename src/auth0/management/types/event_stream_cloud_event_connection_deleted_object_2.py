...
class EventStreamCloudEventConnectionDeletedObject2(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject2Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject2Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject2Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject2StrategyEnum
