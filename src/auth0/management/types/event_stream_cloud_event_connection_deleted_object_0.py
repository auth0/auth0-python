...
class EventStreamCloudEventConnectionDeletedObject0(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject0Authentication] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject0Metadata] = None
    ...
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts] = None
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject0Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject0StrategyEnum
