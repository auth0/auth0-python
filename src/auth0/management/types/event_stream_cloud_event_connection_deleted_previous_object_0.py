...
from .event_stream_cloud_event_connection_deleted_previous_object_0_authentication import (
    EventStreamCloudEventConnectionDeletedPreviousObject0Authentication,
)
from .event_stream_cloud_event_connection_deleted_previous_object_0_connected_accounts import (
    EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts,
)
from .event_stream_cloud_event_connection_deleted_previous_object_0_metadata import (
    EventStreamCloudEventConnectionDeletedPreviousObject0Metadata,
)
from .event_stream_cloud_event_connection_deleted_previous_object_0_options import (
...
class EventStreamCloudEventConnectionDeletedPreviousObject0(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedPreviousObject0Authentication] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedPreviousObject0Metadata] = None
    ...
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts] = None
    options: typing.Optional[EventStreamCloudEventConnectionDeletedPreviousObject0Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum
