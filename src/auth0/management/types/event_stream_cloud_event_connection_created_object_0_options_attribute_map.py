...
class EventStreamCloudEventConnectionCreatedObject0OptionsAttributeMap(UniversalBaseModel):
    """
    ...
    attributes: typing.Optional[EventStreamCloudEventConnectionCreatedObject0OptionsAttributeMapAttributes] = None
    userinfo_scope: typing.Optional[str] = pydantic.Field(default=None)
    """
    Scopes to send to the IdP's Userinfo endpoint
    """

    mapping_mode: typing.Optional[EventStreamCloudEventConnectionCreatedObject0OptionsAttributeMapMappingModeEnum] = (
        None
    )
