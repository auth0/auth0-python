...
class EventStreamCloudEventConnectionDeletedObject1(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject1Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject1ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject1Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject1Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject1StrategyEnum
