...
class PatchRateLimitPolicyConfigurationRequestContentZero(UniversalBaseModel):
    action: PatchRateLimitPolicyConfigurationRequestContentZeroAction = pydantic.Field()
    """
