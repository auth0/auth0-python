...
class EventStreamCloudEventConnectionCreatedObject1OptionsConnectionSettings(UniversalBaseModel):
    """
    ...
    pkce: typing.Optional[EventStreamCloudEventConnectionCreatedObject1OptionsConnectionSettingsPkceEnum] = None
