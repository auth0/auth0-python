...
from .client_authentication_method_private_key_jwt_credentials import ClientAuthenticationMethodPrivateKeyJwtCredentials


class ClientAuthenticationMethodPrivateKeyJwt(UniversalBaseModel):
    """
