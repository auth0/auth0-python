...
class EventStreamCloudEventConnectionCreatedObject4Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionCreatedObject4OptionsUpstreamParams] = None
