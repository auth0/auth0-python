...
from .event_stream_cloud_event_org_group_role_deleted_previous_object import (
    EventStreamCloudEventOrgGroupRoleDeletedPreviousObject,
)


class EventStreamCloudEventOrgGroupRoleDeletedData(UniversalBaseModel):
    """
    The event payload.
    """

    object: EventStreamCloudEventOrgGroupRoleDeletedObject
    previous_object: typing.Optional[EventStreamCloudEventOrgGroupRoleDeletedPreviousObject] = None
