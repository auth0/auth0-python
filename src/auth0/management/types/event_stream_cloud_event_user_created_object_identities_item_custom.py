...
class EventStreamCloudEventUserCreatedObjectIdentitiesItemCustom(UniversalBaseModel):
    """
    ...
    profile_data: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventUserCreatedObjectIdentitiesItemCustomProfileData],
        FieldMetadata(alias="profileData"),
        pydantic.Field(alias="profileData"),
    ] = None
    provider: EventStreamCloudEventUserCreatedObjectIdentitiesItemCustomProviderEnum
