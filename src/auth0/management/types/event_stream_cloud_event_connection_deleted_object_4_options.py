...
class EventStreamCloudEventConnectionDeletedObject4Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject4OptionsUpstreamParams] = None
