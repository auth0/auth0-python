...
class EventStreamCloudEventConnectionDeletedObject0Options(UniversalBaseModel):
    """
    ...
    connection_settings: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsConnectionSettings] = None
    ...
    dpop_signing_alg: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsDpopSigningAlgEnum] = None
    ...
    id_token_signed_response_algs: typing.Optional[
        typing.List[EventStreamCloudEventConnectionDeletedObject0OptionsIdTokenSignedResponseAlgsItemEnum]
    ...
    oidc_metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsOidcMetadata] = None
    schema_version: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsSchemaVersionEnum] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsUpstreamParams] = None
    ...
    attribute_map: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsAttributeMap] = None
    ...
    type: typing.Optional[EventStreamCloudEventConnectionDeletedObject0OptionsTypeEnum] = None
