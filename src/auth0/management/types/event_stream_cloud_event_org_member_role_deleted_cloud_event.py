...
class EventStreamCloudEventOrgMemberRoleDeletedCloudEvent(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventOrgMemberRoleDeletedData
