...
class EventStreamCloudEventOrgCreatedCloudEvent(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventOrgCreatedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventOrgCreatedData
