...
class EventStreamCloudEventConnectionDeletedObject4(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject4Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject4ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject4Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject4Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject4StrategyEnum
