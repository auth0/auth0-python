...
class EventStreamCloudEventConnectionCreatedObject6Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionCreatedObject6OptionsUpstreamParams] = None
