...
class EventStreamCloudEventConnectionUpdatedObject1OptionsConnectionSettings(UniversalBaseModel):
    """
    ...
    pkce: typing.Optional[EventStreamCloudEventConnectionUpdatedObject1OptionsConnectionSettingsPkceEnum] = None
