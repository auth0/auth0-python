...
from .event_stream_cloud_event_connection_deleted_object_2_options_oidc_metadata import (
...
class EventStreamCloudEventConnectionDeletedObject2Options(UniversalBaseModel):
    ...
    oidc_metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject2OptionsOidcMetadata] = None
