...
class EventStreamCloudEventConnectionDeletedObject3(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject3Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject3ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject3Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject3Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject3StrategyEnum
