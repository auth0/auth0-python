...
class EventStreamCloudEventConnectionDeletedObject7(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionDeletedObject7Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject7Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionDeletedObject7Options] = None
    ...
    strategy: EventStreamCloudEventConnectionDeletedObject7StrategyEnum
