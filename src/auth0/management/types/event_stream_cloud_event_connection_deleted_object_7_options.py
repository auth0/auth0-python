...
class EventStreamCloudEventConnectionDeletedObject7Options(UniversalBaseModel):
    """
    ...
    identity_api: typing.Optional[EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum] = None
    ...
    tenant_domain: typing.Optional[EventStreamCloudEventConnectionDeletedObject7OptionsTenantDomainOne] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject7OptionsUpstreamParams] = None
    ...
    userid_attribute: typing.Optional[EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum] = None
    waad_protocol: typing.Optional[EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum] = None
