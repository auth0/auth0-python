...
class EventStreamCloudEventConnectionUpdatedCloudEvent(UniversalBaseModel):
    """
    Represents an event that occurs when a connection is updated.
    """

    specversion: EventStreamCloudEventSpecVersionEnum
    type: EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventConnectionUpdatedData
