...
class EventStreamCloudEventConnectionDeletedObject3Options(UniversalBaseModel):
    """
    ...
    digest_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsDigestAlgorithmEnum],
    ...
    idpinitiated: typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsIdpinitiated] = None
    ...
    protocol_binding: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsProtocolBindingEnum],
    ...
    signature_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsSignatureAlgorithmEnum],
    ...
    subject: typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsSubject] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject3OptionsUpstreamParams] = None
