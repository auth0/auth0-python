...
class EventStreamCloudEventConnectionDeletedCloudEvent(UniversalBaseModel):
    """
    Represents an event that occurs when a connection is deleted.
    """

    specversion: EventStreamCloudEventSpecVersionEnum
    type: EventStreamCloudEventConnectionDeletedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventConnectionDeletedData
