...
class EventStreamCloudEventUserCreatedCloudEvent(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventUserCreatedCloudEventTypeEnum
    ...
    data: EventStreamCloudEventUserCreatedData
