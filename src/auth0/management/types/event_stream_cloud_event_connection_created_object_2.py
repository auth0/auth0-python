...
class EventStreamCloudEventConnectionCreatedObject2(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionCreatedObject2Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionCreatedObject2ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject2Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionCreatedObject2Options] = None
    ...
    strategy: EventStreamCloudEventConnectionCreatedObject2StrategyEnum
