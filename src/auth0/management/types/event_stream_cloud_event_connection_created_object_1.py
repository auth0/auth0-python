...
class EventStreamCloudEventConnectionCreatedObject1(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionCreatedObject1Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionCreatedObject1ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject1Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionCreatedObject1Options] = None
    ...
    strategy: EventStreamCloudEventConnectionCreatedObject1StrategyEnum
