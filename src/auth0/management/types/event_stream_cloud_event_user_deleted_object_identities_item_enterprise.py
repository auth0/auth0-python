...
class EventStreamCloudEventUserDeletedObjectIdentitiesItemEnterprise(UniversalBaseModel):
    """
    ...
    user_id: EventStreamCloudEventUserDeletedObjectIdentitiesItemEnterpriseUserId
    profile_data: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventUserDeletedObjectIdentitiesItemEnterpriseProfileData],
        FieldMetadata(alias="profileData"),
        pydantic.Field(alias="profileData"),
    ] = None
    provider: EventStreamCloudEventUserDeletedObjectIdentitiesItemEnterpriseProviderEnum
