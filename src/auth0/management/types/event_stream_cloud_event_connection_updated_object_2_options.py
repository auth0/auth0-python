...
class EventStreamCloudEventConnectionUpdatedObject2Options(UniversalBaseModel):
    """
    ...
    digest_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsDigestAlgorithmEnum],
    ...
    idpinitiated: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsIdpinitiated] = None
    ...
    protocol_binding: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum],
    ...
    signature_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsSignatureAlgorithmEnum],
    ...
    subject: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsSubject] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionUpdatedObject2OptionsUpstreamParams] = None
