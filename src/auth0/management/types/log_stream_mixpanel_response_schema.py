...
class LogStreamMixpanelResponseSchema(UniversalBaseModel):
    ...
    type: typing.Optional[LogStreamMixpanelEnum] = None
    ...
    sink: typing.Optional[LogStreamMixpanelSink] = None
