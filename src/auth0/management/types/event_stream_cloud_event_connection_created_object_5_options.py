...
class EventStreamCloudEventConnectionCreatedObject5Options(UniversalBaseModel):
    """
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionCreatedObject5OptionsUpstreamParams] = None
