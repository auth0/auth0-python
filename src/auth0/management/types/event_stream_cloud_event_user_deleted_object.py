...
from .event_stream_cloud_event_user_deleted_object_app_metadata import EventStreamCloudEventUserDeletedObjectAppMetadata
...
class EventStreamCloudEventUserDeletedObject(UniversalBaseModel):
    """
    The event content.
    """
    ...
    identities: typing.List[EventStreamCloudEventUserDeletedObjectIdentitiesItem] = pydantic.Field()
    """
    Array of user identity objects when accounts are linked.
    """

    app_metadata: typing.Optional[EventStreamCloudEventUserDeletedObjectAppMetadata] = None
    user_metadata: typing.Optional[EventStreamCloudEventUserDeletedObjectUserMetadata] = None
