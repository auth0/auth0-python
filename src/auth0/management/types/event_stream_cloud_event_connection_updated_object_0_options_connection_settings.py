...
class EventStreamCloudEventConnectionUpdatedObject0OptionsConnectionSettings(UniversalBaseModel):
    """
    ...
    pkce: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsConnectionSettingsPkceEnum] = None
