...
from .event_stream_cloud_event_connection_created_object_2_options_oidc_metadata import (
...
class EventStreamCloudEventConnectionCreatedObject2Options(UniversalBaseModel):
    """
    ...
    digest_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsDigestAlgorithmEnum],
    ...
    idpinitiated: typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsIdpinitiated] = None
    ...
    protocol_binding: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum],
    ...
    signature_algorithm: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsSignatureAlgorithmEnum],
    ...
    subject: typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsSubject] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsUpstreamParams] = None
    ...
    fields_map: typing_extensions.Annotated[
        typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsFieldsMap],
    ...
    oidc_metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject2OptionsOidcMetadata] = None
