...
class EventStreamCloudEventConnectionCreatedObject6(UniversalBaseModel):
    authentication: typing.Optional[EventStreamCloudEventConnectionCreatedObject6Authentication] = None
    connected_accounts: typing.Optional[EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts] = None
    ...
    metadata: typing.Optional[EventStreamCloudEventConnectionCreatedObject6Metadata] = None
    ...
    options: typing.Optional[EventStreamCloudEventConnectionCreatedObject6Options] = None
    ...
    strategy: EventStreamCloudEventConnectionCreatedObject6StrategyEnum
