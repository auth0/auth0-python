...
class EventStreamCloudEventConnectionDeletedObject1Options(UniversalBaseModel):
    """
    ...
    connection_settings: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsConnectionSettings] = None
    ...
    dpop_signing_alg: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsDpopSigningAlgEnum] = None
    ...
    id_token_signed_response_algs: typing.Optional[
        typing.List[EventStreamCloudEventConnectionDeletedObject1OptionsIdTokenSignedResponseAlgsItemEnum]
    ...
    oidc_metadata: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsOidcMetadata] = None
    schema_version: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsSchemaVersionEnum] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsUpstreamParams] = None
    ...
    attribute_map: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsAttributeMap] = None
    ...
    type: typing.Optional[EventStreamCloudEventConnectionDeletedObject1OptionsTypeEnum] = None
