...
class EventStreamCloudEventConnectionUpdatedObject0Options(UniversalBaseModel):
    """
    ...
    connection_settings: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsConnectionSettings] = None
    ...
    dpop_signing_alg: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsDpopSigningAlgEnum] = None
    ...
    id_token_signed_response_algs: typing.Optional[
        typing.List[EventStreamCloudEventConnectionUpdatedObject0OptionsIdTokenSignedResponseAlgsItemEnum]
    ...
    oidc_metadata: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsOidcMetadata] = None
    schema_version: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsSchemaVersionEnum] = None
    ...
    upstream_params: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsUpstreamParams] = None
    ...
    attribute_map: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsAttributeMap] = None
    ...
    type: typing.Optional[EventStreamCloudEventConnectionUpdatedObject0OptionsTypeEnum] = None
