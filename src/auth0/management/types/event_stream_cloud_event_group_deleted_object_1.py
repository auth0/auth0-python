...
from .event_stream_cloud_event_group_deleted_object_1_type_enum import EventStreamCloudEventGroupDeletedObject1TypeEnum


class EventStreamCloudEventGroupDeletedObject1(UniversalBaseModel):
    """
    ...
    type: EventStreamCloudEventGroupDeletedObject1TypeEnum
