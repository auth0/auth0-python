...
class RawConnectionsClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ListFlowsVaultConnectionsOffsetPaginatedResponseContent,
                    parse_obj_as(
                        type_=ListFlowsVaultConnectionsOffsetPaginatedResponseContent,  # type: ignore
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        request : CreateFlowsVaultConnectionRequestContent
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateFlowsVaultConnectionResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
    ...
    ) -> HttpResponse[GetFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        id : str
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetFlowsVaultConnectionResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "name": name,
                "setup": convert_and_respect_annotation_metadata(
                    object_=setup, annotation=UpdateFlowsVaultConnectionSetup, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateFlowsVaultConnectionResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawConnectionsClient:
    ...
    async def create(
        ...
        *,
        request: CreateFlowsVaultConnectionRequestContent,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        request : CreateFlowsVaultConnectionRequestContent
    ...
    async def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        id : str
    ...
    async def update(
        ...
        *,
        ...
        setup: typing.Optional[UpdateFlowsVaultConnectionSetup] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateFlowsVaultConnectionResponseContent]:
        """
        Parameters
        ----------
        id : str
