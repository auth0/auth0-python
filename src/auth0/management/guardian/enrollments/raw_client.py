...
class RawEnrollmentsClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateGuardianEnrollmentTicketResponseContent,  # type: ignore
    ...
    def get(
    ...
    ) -> HttpResponse[GetGuardianEnrollmentResponseContent]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"guardian/enrollments/{jsonable_encoder(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetGuardianEnrollmentResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawEnrollmentsClient:
    ...
    async def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetGuardianEnrollmentResponseContent]:
        """
        Retrieve details, such as status and type, for a specific multi-factor authentication enrollment registered to a user account.
