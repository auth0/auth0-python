...
class RawSettingsClient:
    ...
    ) -> HttpResponse[GetRiskAssessmentsSettingsResponseContent]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetRiskAssessmentsSettingsResponseContent,  # type: ignore
    ...
    ) -> HttpResponse[UpdateRiskAssessmentsSettingsResponseContent]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateRiskAssessmentsSettingsResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawSettingsClient:
    ...
    async def get(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetRiskAssessmentsSettingsResponseContent]:
        """
        Gets the tenant settings for risk assessments
    ...
    async def update(
        self, *, enabled: bool, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[UpdateRiskAssessmentsSettingsResponseContent]:
        """
        Updates the tenant settings for risk assessments
