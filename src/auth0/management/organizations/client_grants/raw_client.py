...
class RawClientGrantsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organizations/{jsonable_encoder(id)}/client-grants",
            method="GET",
            params={
                "audience": audience,
                "client_id": client_id,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ListOrganizationClientGrantsOffsetPaginatedResponseContent,
                    parse_obj_as(
                        type_=ListOrganizationClientGrantsOffsetPaginatedResponseContent,  # type: ignore
    ...
    ) -> HttpResponse[AssociateOrganizationClientGrantResponseContent]:
        """
        Parameters
        ----------
        id : str
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    AssociateOrganizationClientGrantResponseContent,
                    parse_obj_as(
                        type_=AssociateOrganizationClientGrantResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
    ...
    def delete(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organizations/{jsonable_encoder(id)}/client-grants/{jsonable_encoder(grant_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
...
class AsyncRawClientGrantsClient:
    ...
    async def create(
        self, id: str, *, grant_id: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AssociateOrganizationClientGrantResponseContent]:
        """
        Parameters
        ----------
        id : str
