...
class RawRedeliveriesClient:
    ...
    ) -> HttpResponse[CreateEventStreamRedeliveryResponseContent]:
        """
        Parameters
        ----------
        id : str
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateEventStreamRedeliveryResponseContent,  # type: ignore
...
class AsyncRawRedeliveriesClient:
    ...
    async def create(
        ...
        *,
        ...
        event_types: typing.Optional[typing.Sequence[EventStreamEventTypeEnum]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateEventStreamRedeliveryResponseContent]:
        """
        Parameters
        ----------
        id : str
