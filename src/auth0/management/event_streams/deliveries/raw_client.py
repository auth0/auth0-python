...
class RawDeliveriesClient:
    ...
    ) -> HttpResponse[GetEventStreamDeliveryHistoryResponseContent]:
        """
        Parameters
        ----------
        id : str
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetEventStreamDeliveryHistoryResponseContent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawDeliveriesClient:
    ...
    async def get_history(
        self, id: str, event_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetEventStreamDeliveryHistoryResponseContent]:
        """
        Parameters
        ----------
        id : str
